...
export default function KickstarterCTA() {
    return (
        <section id="kickstarter" className="w-full bg-[#000000] text-[#FFFFFF] py-32 px-6">
            <motion.div
            ...
            >
                ...
                <p className="text-[21px] text-[#999999] mt-4 max-w-[600px] mx-auto leading-relaxed">
                    Back us on Kickstarter and shape the future of AI video creation.
                </p>
                ...
                <a
                    ...
                    aria-label="Back project on Kickstarter"
                >
                    Back this Project →
                </a>
            </motion.div>
